...
* <a href="https://services.myeasywp.com/?page=services" title="Improve Your Life, Go The myEASY Way">Check out what is going on at the dedicated server site</a>
...
1. Activate the plugin through the 'Plugins' menu in the WordPress Administration page. Note: to be able to activate the the plugin you need to enter your own API key; you can create your free API key at http://services.myeasywp.com/?page=account-add
...
For an updated list of FAQ, please check the 'plugins' menu at the official site &ndash; http://myeasywp.com &ndash; if there is a FAQ you will find its link there.
